...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ligabalon@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ligabalon API";

        private String description = "ligabalon API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ligabalon";
